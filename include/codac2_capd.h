...
{
  /**
   * \brief Casts a reference to a Codac Interval object into a reference to an CAPD Interval object
   * 
   * \param x Codac type Interval
   * \return CAPD type Interval
   */
  capd::Interval& to_capd(codac2::Interval& x);

  /**
   * \brief Casts a Codac Interval object into an CAPD Interval object
   * 
   * \param x const Codac type Interval
   * \return const CAPD type Interval
   */
  const capd::Interval& to_capd(const codac2::Interval& x);
