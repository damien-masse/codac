...
namespace codac2
{
  ...
  /**
   * \class Interval2
   * \brief Interval2 class, for representing closed and connected subsets of \f$\mathbb{R}\f$.
   *
   ...
   *    https://ibex-lib.readthedocs.io
   */
  class Interval2 : private gaol::interval, public DomainInterface<Interval2,double>
  {
    public:
       ...
       */
      explicit Interval2(const std::array<double,1>& array);
       ...
       * \param array the array of doubles
       */
      explicit Interval2(const std::array<double,2>& array);
       ...
       */
      Interval2(std::initializer_list<double> l);
       ...
       */
      Interval2& init(const Interval2& x);
       ...
       * \return a reference to this
       */
      Interval2& init_from_list(const std::list<double>& l);
       ...
       * \return a reference to this
       */
      Interval2& operator=(const Interval2& x);
       ...
       */
      bool operator==(const Interval2& x) const;
       ...
       */
      bool intersects(const Interval2 &x) const;
       ...
       */
      bool is_disjoint(const Interval2& x) const;
       ...
       */
      bool overlaps(const Interval2 &x) const;
       ...
       */
      bool is_subset(const Interval2& x) const;
       ...
       */
      bool is_strict_subset(const Interval2& x) const;
       ...
       */
      bool is_interior_subset(const Interval2& x) const;
       ...
       */
      bool is_strict_interior_subset(const Interval2& x) const;
       ...
       */
      bool is_superset(const Interval2& x) const;
       ...
       */
      bool is_strict_superset(const Interval2& x) const;
       ...
       * \return a reference to this
       */
      Interval2& inflate(const double& rad);
       ...
       */
      std::pair<Interval2,Interval2> bisect(float ratio = 0.49) const;
       ...
       */
      std::vector<Interval2> complementary(bool compactness = true) const;
       ...
       */
      std::vector<Interval2> diff(const Interval2& y, bool compactness = true) const;
       ...
       */
      static Interval2 two_pi();
      
      friend std::ostream& operator<<(std::ostream& os, const Interval2& x);

    protected:
      
      Interval2(const gaol::interval& x);

      /*friend ibex::Interval2& to_ibex(codac2::Interval2& x);
      friend const ibex::Interval2& to_ibex(const Interval2& x);
      friend Interval2 to_codac(const ibex::Interval2& x);*/

      #define _dec_friend_interval2_arithm_op(f) \
        friend Interval2 f(double, const Interval2&); \
        friend Interval2 f(const Interval2&, double); \
        friend Interval2 f(const Interval2&, const Interval2&); \
      ...
      #define _dec_friend_interval2_unary_op(f) \
        friend Interval2 f(const Interval2&); \
      ...
      friend Interval2 pow(const Interval2&, int);
      friend Interval2 pow(const Interval2&, double);

      _dec_friend_interval2_binary_op(pow)

      friend Interval2 root(const Interval2&, int);

      /*#define _dec_friend_interval2_unary_bwd(f) \
        friend void f(const Interval2&, Interval2&); \

      _dec_friend_interval2_unary_bwd(bwd_sqr)
      _dec_friend_interval2_unary_bwd(bwd_sqrt)
      _dec_friend_interval2_unary_bwd(bwd_exp)
      _dec_friend_interval2_unary_bwd(bwd_log)
      _dec_friend_interval2_unary_bwd(bwd_cos)
      _dec_friend_interval2_unary_bwd(bwd_sin)
      _dec_friend_interval2_unary_bwd(bwd_tan)
      _dec_friend_interval2_unary_bwd(bwd_acos)
      _dec_friend_interval2_unary_bwd(bwd_asin)
      _dec_friend_interval2_unary_bwd(bwd_atan)
      _dec_friend_interval2_unary_bwd(bwd_cosh)
      _dec_friend_interval2_unary_bwd(bwd_sinh)
      _dec_friend_interval2_unary_bwd(bwd_tanh)
      _dec_friend_interval2_unary_bwd(bwd_acosh)
      _dec_friend_interval2_unary_bwd(bwd_asinh)
      _dec_friend_interval2_unary_bwd(bwd_atanh)
      _dec_friend_interval2_unary_bwd(bwd_abs)
      _dec_friend_interval2_unary_bwd(bwd_sign)
      _dec_friend_interval2_unary_bwd(bwd_floor)
      _dec_friend_interval2_unary_bwd(bwd_ceil)
      _dec_friend_interval2_unary_bwd(bwd_saw)

      #define _dec_friend_interval2_binary_bwd(f) \
        friend void f(const Interval2&, Interval2&, Interval2&); \
      
      _dec_friend_interval2_binary_bwd(bwd_add)
      _dec_friend_interval2_binary_bwd(bwd_sub)
      _dec_friend_interval2_binary_bwd(bwd_mul)
      _dec_friend_interval2_binary_bwd(bwd_div)
      _dec_friend_interval2_binary_bwd(bwd_pow)
      _dec_friend_interval2_binary_bwd(bwd_min)
      _dec_friend_interval2_binary_bwd(bwd_max)
      _dec_friend_interval2_binary_bwd(bwd_atan2)

      friend void bwd_pow(const Interval2&, Interval2&, int);
      friend void bwd_root(const Interval2&, Interval2&, int);
      friend void bwd_imod(Interval2&, Interval2&, double);*/
  };
   ...
   */
  std::ostream& operator<<(std::ostream& os, const Interval2& x);
   ...
   */
  Interval2 operator""_i(long double x);
...
//}
   ...
   */
  Interval2 operator&(const Interval2& x, const Interval2& y);
   ...
   */
  const Interval2& operator+(const Interval2& x);
   ...
   */
  Interval2 operator+(const Interval2& x, double y);
   ...
   * \return the addition result
   */
  Interval2 operator+(double x, const Interval2& y);
...
#include "codac2_Interval2_impl.h"