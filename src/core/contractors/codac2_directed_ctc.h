...
{/*
  ...
  struct VectorOp
  {
    ...
    static VectorType fwd_natural(const X&... x)
    {
    ...
    template<typename... X>
      requires (std::is_base_of_v<ScalarType,X> && ...)
    static VectorType fwd_centered(const X&... x)
    {
  ...
  struct MatrixOp
  {
    ...
    static MatrixType fwd_natural(const X&... x)
    {
      throw std::runtime_error("MatrixOp not fully implemented yet");
      return {
        IntervalMatrix({x.a...}),
    ...
    template<typename... X>
      requires (std::is_base_of_v<VectorType,X> && ...)
    static MatrixType fwd_centered(const X&... x)
    {
      throw std::runtime_error("MatrixOp not fully implemented yet");
      return {
        IntervalMatrix({x.m...}),
