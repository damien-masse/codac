...
DefaultView.draw_AUV([1,1,3.14/2],1.,StyleProperties([Color.black(),Color.yellow()],LineStyle.DASH_DOT_DOTTED))
...
fig2.draw_AUV([1,1,3.14/2],2.,StyleProperties([Color.black(),Color.yellow()],LineStyle.DASH_DOT_DOTTED, "vehicles"))
...
fig2.draw_polyline([[2,-0.5],[4,0.5],[3,1.5],[4,2.5],[3,3]], StyleProperties(Color.red(),LineStyle.DOTTED))
