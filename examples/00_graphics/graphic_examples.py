...
DefaultView.draw_AUV([1,1,3.14/2],1.,StyleProperties([Color.black(),Color.yellow()],"-.."))
DefaultView.draw_motor_boat([0,0,0], 1., [Color.black(),Color.yellow()])
DefaultView.draw_tank([2,1,3.14/2],1.,StyleProperties([Color.black(),Color.yellow()],"vehicles","-."))
