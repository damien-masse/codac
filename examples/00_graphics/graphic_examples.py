...
fig2.draw_AUV([1,1,3.14/2],2.,StyleProperties([Color.black(),Color.yellow()],"-..", "vehicles","0.1"))
fig2.draw_tank([2,1,3.14/2],1.,StyleProperties([Color.black(),Color.yellow()],"vehicles","0.4"))
