...
if __name__=="__main__":
  ...
  figure_2d = Figure2D("Henon Map", GraphicOutput.VIBES | GraphicOutput.IPE)
  figure_2d.set_window_properties([25,50],[500,500])
  figure_2d.set_axes(axis(0,[-1.,2.2]), axis(1,[-0.35,0.35]))

  for par in v_par_2d:
    figure_2d.draw_parallelepiped(par,[Color.yellow(),Color.yellow(0.5)])
  ...
  for p in v_par_3d:
    figure_3d.draw_parallelepiped(p,Color.yellow(0.5))
